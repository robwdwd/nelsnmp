...
from netdevsnmp.vendors.mappings import vendor_map

o = GeneralOids()


class HostInfo(object):
    def __init__(self, Snmp, contact=None, description=None, location=None, os=None, vendor=None, sysobjectid=None):
    ...
    def get_version(self):
        ...
        version_info = get_device_version(
            sysobjectid=self.sysobjectid, description=self.description, vendor=self.vendor, snmp=self._snmp
        )
